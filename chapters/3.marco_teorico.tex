...
\item ChatBot: Para este protyecto se utiliza el concepto de \textit{chatbot}, el cual podemos definir como, un sistema con el que el usuario puede interactuar generando una conversacion en lenguaje natural, haciendo preguntas acerca de diversos temas por medio de voz o texto, este sistema podra aprender, entender y adaptarse a un contexto de diversos temas, además el chatbot podra hacer recomendaciones acerca de información que el usuario necesite o le pueda ser de ayuda\cite{chatbot_AWS,chatbot_IBM}.
...
\item Notas: El uso del concepto de Nota podemos entenderlo como anotaciones complejas y organizadas que nos son utiles para la comprensión de un tema, estas pueden ayudar a complementar o mejorar los apuntes, presenta un mayor desarrollo en la informacion\cite{nota}. 
