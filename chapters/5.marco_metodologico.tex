...
Para el desarrollo de este proyecto se seguirá una metodología basada en el enfoque ágil basada en el proceso unificado de software \textit{(Agile Unified Process)}, que permite una adaptación continua a los cambios y una entrega incremental de funcionalidades.\\
