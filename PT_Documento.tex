...
\noindent En la figura\ref{fig:Contexto} podemos observar un flujo que describe el contexto de uso de la aplicacion gestor de notas inteligente, en el cual el principal actor son el usuario y las notas, de esta manera como podemos ver en el \textbf{punto 1} se muestra como el usuario generá notas y apuntes de diferentes fuentes o de diferentes situaciones en las que unicamente muestra la generacion sin dar una organización o etiquetado, despues pasamos al \textbf{punto 2} en el cual mostramos como se da la colaboracion entre mas usuarios buscando complementar las notas que el usuario realice o comparando su contenido con el de otras personas como podemos ver el proceso se repite de manera frecuente hasta que el usuario recopila una gran cantidad de notas de diversos temas como lo muestra en el \textbf{punto 3}, después el usuario a partir de estas conjunto de notas que poseé necesita consultarlas o generar nuevas notas a partir de estas pero nos encontramos con tres principales problematicas, estas probematicas nos permiten presentar la solución de la aplicacion gestor de notas inteligente:
\begin{itemize}
...
\noindent Una vez conociendo las problematicas con las que el usuario se puede encontrar al hacer tener la necesidad de consultar sus notas como se mostro en el \textbf{punto 4}, podemos ver el inicio de uso de la aplicación el cual se muestra en el \textbf{punto 5 }, en el que se muestra como el usuario centraliza o adjunta todas sus notas en una aplicación en la que como resultado se genera o se crea una base de datos, que se puede describir mejor como una base que contiene todo el conocimiento que el usuario generé ver en el \textbf{punto 6}, de esta manera la aplicacion contiene un sistema clasificador en el que organiza los documentos con etiquetas o buscando similitudes en su contenido organizandolas por temas como se muestra en el \textbf{punto 7}, de esta manera como se puede observar en el punto 8 el usuario hace consultas a un chat a la aplicacion acerca de sus notas \textbf{punto 8} y \textbf{punto 9}, finalizando el sistema podra responder de dos maneras, \textbf{punto 11} el sistema clasificador encontro la respuesta para la pregunta del usuario o \textbf{punto 12} en la que el sistema no logro encontrar ningun tema relacionado con la pregunta del usuario. de esta manera se finaliza el contexto de uso de la aplicación gestor de notas inteligente.

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Contexto.png}
...
\noindent Por lo tanto esta comparativa mostrada en el cuadro 3.1 nos muestra las principales diferencias entre las aplicaciones existente en el mercado y el gestor de notas inteligente en el cual podemos concluir que brindar seguridad a los usuarios de que la informacion estara siempre disponible y segura es el principal diferenciador.
...
El proyecto se plantea desarrollar en 3 etapas las cuales las principales actividades y los principales objetivos a cumplir se describiran a travez de un diagramas de Gantt en los cuales se podran encontrar algunos elementos como periodo que se abarca, Tareas u objetivos a realizar y el tiempo esperado en el que se propone cumplir, estos periodos se dividen en los siguientes:
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Diagramas_UML/Prueba.png}
...
\begin{itemize}
    \item NotebookLM  \url{https://notebooklm.google/}
    \item BitChat  \url{https://bit-chats.com/}
    \item No Code Hackers. (s.f.). Notion. No Code Hackers. https://www.nocodehackers.es/herramientas-no-code/notion
    \item Obsidian. (s.f.). Obsidian. Obsidian. https://obsidian.md/
    \item Google. (s.f.). Tu asistente de investigación y organización de ideas basado en IA - Google NotebookLM. Google. https://notebooklm.google/
\end{itemize}
